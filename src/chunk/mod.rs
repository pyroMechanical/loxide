use crate::{value::Value, object::ObjFunction};
        ...
        if op.is_some() {
            ...
            let new_index = match operation {
                ...
                OpCode::Closure => {
                    ...
                    println!("{:04} {} {:?} {} {}", index, line, operation, constant, self.constants[constant as usize]);
                    ...
                    if let Value::Obj(function) = function {
                        ...
                        for i in 0..function.upvalue_count {
                            ...
                            println!("{:04}    | {} {}", offset, if is_local != 0 {"local"} else {"upvale"},index);
                        }
                    }
                    offset
                },
